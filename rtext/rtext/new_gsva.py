...
from gsva.model.llava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX
from gsva.model.modeling_lisa_gsva import LisaGSVAModel
from gsva.model.losses import dice_loss, sigmoid_ce_loss

from .new_gsva_llama import LlavaLlamaForCausalLMInputEmbed


class LisaGSVAEmbedInput(LlavaLlamaForCausalLMInputEmbed):
    def __init__(
        self,
        config,
        **kwargs,
    ...
    def model_forward(
        ...
        inputs_embeds = None,       # need embeddings to be optimized!
        ...
        **kwargs,
        ...
        length = input_ids.shape[0] # length = 1
