...
from lisa_v0.model.segment_anything.utils.transforms import ResizeLongestSide
...
from lisa_v0.utils.vqa_dataset import VQADataset
...
class ValDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        if len(splits) == 1:
            ds, split = "ReasonSeg", "test"
            images = [os.path.join(self.base_image_dir, val_dataset)]
            self.images = images
